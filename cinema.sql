...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2023 at 04:27 PM
...
INSERT INTO `booking` (`booking_id`, `user_id`, `movie_id`) VALUES
(1, 3, 3),
(2, 6, 4),
(3, 3, 3),
(4, 3, 3),
...
(27, 'The Godfather', 'Widely regarded as one of the greatest films of all time, this mob drama, based on Mario Puzo\'s novel of the same name, focuses on the powerful Italian-American crime family of Don Vito Corleone (Marlon Brando). When the don\'s youngest son, Michael (Al Pacino), reluctantly joins the Mafia, he becomes involved in the inevitable cycle of violence and betrayal. Although Michael tries to maintain a normal relationship with his wife, Kay (Diane Keaton), he is drawn deeper into the family business.\r\n', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQ3FFBjN-zw9FIz6i6zQmrV2N_p3kFb89qYQ&usqp=CAU'),
(28, 'The Avengers', 'When Thor\'s evil brother, Loki (Tom Hiddleston), gains access to the unlimited power of the energy cube called the Tesseract, Nick Fury (Samuel L. Jackson), director of S.H.I.E.L.D., initiates a superhero recruitment effort to defeat the unprecedented threat to Earth. Joining Fury\'s \"dream team\" are Iron Man (Robert Downey Jr.), Captain America (Chris Evans), the Hulk (Mark Ruffalo), Thor (Chris Hemsworth), the Black Widow (Scarlett Johansson) and Hawkeye (Jeremy Renner).\r\n', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvgtM_buVNm1Ruh1pCwcgbB436kax-MzNOZg&usqp=CAU'),
(29, 'Hunter X Hunter : Phantom rouge', 'Gon, Killua, Kurapika and Leorio reunite to face a dangerous opponent who was once a member of the Phantom Troupe.', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEXQTK8DyVV6-FSykpHdwtbm1TzXsOsyKHT3TvETzH3x-mx5zLSZ8A-kc8XfIZ4pvPPgk&usqp=CAU');
...
INSERT INTO `users` (`id`, `password`, `email`, `username`, `dob`, `sex`, `lang`, `fname`, `lname`, `license_accepted`) VALUES
(2, '$2y$10$uCS1iHxxvqkhJPyueDYZr.tLM6.muY6DbnIbTbV//IxFfCe9n0UBK', 'Crusader.light@yahoo.com', 'Mazenoo', '2023-01-03', 1, 'en-US', 'mald', 'cope', 1),
(3, '$2y$10$WBM91LSC8c8m4Am2xzV5aegnotviHMz2072cP/vcD25WD2kiTSsGG', 'mazenbasunaid@yahoo.com', 'lolol', '2001-01-18', 1, 'en-US', 'ibrahim', 'suspicous', 1),
(6, '$2y$10$xnnwqcLHBc6eokkHmH0GPO0./qybjoCKBYmC.KjLt0IrPOc4KuiPq', 'ibrahim.mogram@hotmail.com', 'f', '2023-01-03', 1, 'en-US', 'e', 'e', 1);
